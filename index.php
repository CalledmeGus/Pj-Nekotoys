...
<div class="container">
  ...
  <div class=" col-lg-6 py-5 py-lg-0 order-2 order-lg-1" data-aos="fade-right">
    <h1>Your new figures with Neko Toys!!!</h1>
    <h2>We have many anime models that you need.</h2>
    <a href="portfolio" class="btn-get-started scrollto">Let's Shopping!</a>
  </div>
...
<!-- ======= About Section ======= -->
<section id="sign up" class="about section-bg">
  <div class="container">
  ...
  <div class="container">
    ...
    <div class="col-sm-9 padding-right">
                ...
                while($data = mysqli_fetch_array($query)){
							    echo component($data['product_Name'],$data['product_Detail'],$data['price'],$data['image'],$data['id']);
                }
            ?>
...
<section id="portfolio" class="portfolio section-bg">
  <div class="container">
    ...
    <div class="section-title">
      ...
      <p data-aos="fade-in">เชิญเลือกชมสินค้าที่ท่านสนใจ</p>
    </div>
    ...
    <div class="row">
      <div class="col-lg-12">
        <ul id="portfolio-flters">
          ...
          <li data-filter=".filter-Demon Slayer">Demon Slayer</li>
          <li data-filter=".filter-Marvel">Marvel</li>
          <li data-filter=".filter-One-Piece">One-Piece</li>
        </ul>
      </div>
    </div>
    ...
    <div class="row portfolio-container" data-aos="fade-up">
      ...
      <div class="col-lg-4 col-md-6 portfolio-item filter-Demo Slayer">
        <div class="portfolio-wrap">
          <img src="assets/img/portfolio/Tangiro&Nezuko.jpg" class="img-fluid" alt="">
          <div class="portfolio-links">
            <a href="assets/img/portfolio/Tangiro&Nezuko.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Tangiro&Nezuko"><i class="bi bi-plus"></i></a>
            <a href="products-details.html" title="More Details"><i class="bi bi-link"></i></a>
          </div>
          <div class="portfolio-info">
            <h4>Tangiro&Nezuko</h4>
            <p>Demon Slayer</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 portfolio-item filter-web">
        <div class="portfolio-wrap">
          <img src="assets/img/portfolio/Zenitsu.jpg" class="img-fluid" alt="">
          <div class="portfolio-links">
            <a href="assets/img/portfolio/Zenitsu.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Zenitsu"><i class="bi bi-plus"></i></a>
            <a href="products-details.html" title="More Details"><i class="bi bi-link"></i></a>
          </div>
          <div class="portfolio-info">
            <h4>Zenitsu</h4>
...
<!-- ======= Contact Section ======= -->
<section id="log in" class="contact section-bg">
